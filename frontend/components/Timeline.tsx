...
const groupArticlesByDate = (products) => {
  return products.reduce((prev, article) => {
...
export default function Timeline({ products, sort }: TimelineProps) {
  const sortMethod = sort === "Latest" ? sortByLatest : sortByEarliest;
  const groupedArticles = useMemo(
    () => groupArticlesByDate(products),
    [products]
  );
